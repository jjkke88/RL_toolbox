...
from agent.TRPO_parallel_agent import TRPOParallelAgent
from toolbox.baseline.baseline_lstsq import Baseline
from toolbox.distribution.diagonal_gaussian import DiagonalGaussian
...
if __name__ == "__main__":
    ...
    net = NetworkContinous("continous")
    baseline = Baseline()
    distribution = DiagonalGaussian(pms.action_shape)
    rollouts = ParallelStorage(pms=pms , net_class=NetworkContinous)
